...
class Events
{
    ...
    public static function onConnect($client_id)
    {
       ...
       // Log::channel('chatlog')->info('adminlog ok');
        ...
        switch($message_data['type'])
        {
            ...
            case 'login':
                ...
                */
                ...
                Gateway::bindUid($client_id,$fromid);//客户端id与fromid绑定
                return;
...
//                $client_name = $_SESSION['client_name'];
                ...
                $fromid = isset($message_data['fromid'])?$message_data['fromid']:'123';
                $toid = isset($message_data['toid'])?$message_data['toid']:'1';
                ...
                Gateway::sendToClient($message_data['to_client_id'], json_encode($data));
