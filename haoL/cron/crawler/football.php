...
$html = QueryList::get('https://www.qtx.com/dbsoccer')->getHtml();
//获取所有联赛
...
//    $leagueId = $leagueId[1];
    ...
    $leagueId = $crawlerModel->newLeague($legendName,$info['link'], 1);
    //赛程抓取
...
", $time);
        ...
        $timeNoExecute = mb_substr(trim($time1Execute[1]),3);

        $time2 = str_replace("/", "-", trim($timeNoExecute));
